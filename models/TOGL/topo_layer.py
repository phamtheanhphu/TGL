...
import models.TOGL.coord_transforms as coord_transforms
from models.TOGL.layers import fake_persistence_computation  # , EdgeDropout
...
class TopologyLayer(torch.nn.Module):
    ...
    def compute_persistence(self, x, batch, return_filtration=False):
        ...
        print(persistence0_new.size())
        print(persistence1_new.size())
        exit()
    ...
    def forward(self, x, batch, return_filtration=False):
        ...
        if self.dim1:
            ...
            graph_activations1 = self.collapse_dim1(coord_activations1, persistence1_mask, batch[
